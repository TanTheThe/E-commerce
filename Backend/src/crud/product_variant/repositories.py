...
class ProductVariantRepository:
    ...
    async def get_product_variant(self, session: AsyncSession,
                        select_columns: Optional[List[Any]] = None,
                        joins: Optional[List[Tuple[Any, dict]]] = None,
                        where_conditions: Optional[List[ColumnElement[bool]]] = None,
                        group_by_columns: Optional[List[Any]] = None,
    ...
    async def delete_product_variant(self, condition: Optional[List[ColumnElement[bool]]], session: AsyncSession):
        product_variant_delete = await self.get_product_variant(session=session, where_conditions=condition)
    ...
    async def bulk_delete_product_variants(self, variant_ids: List[str], session: AsyncSession):
        stmt = (
            update(Product_Variant)
            .where(Product_Variant.id.in_(variant_ids))
