                        ...
                        <div className="col2 flex items-center justify-end">
                            <ul className="flex items-center gap-3">
                                <li className="list-none">
                                    <Link to="/help-center" className="text-[14px] link font-[500] transition">
                                        Help Center
                                    </Link>
                                </li>
                                <li className="list-none">
                                    <Link to="/order-tracking" className="text-[14px] link font-[500] transition">
                                        Order Tracking
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <ul className="flex items-center justify-end gap-3">
                            {context.isLogin === false ? (
                                <li className="list-none">
                                    ...
                                    <Link to="/signup" className="link transition text-[16px] font-[500]">
                                        Register
                                    </Link>
                                </li>
                            ) : (
