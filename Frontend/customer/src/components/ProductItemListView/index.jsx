...
const ProductItemListView = ({ product = null }) => {
    ...
    if (!product) {
        return (
            <div className="productItem shadow-lg rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center">
                <div className="group imgWrapper w-[30%] h-[250px] bg-gray-200 flex items-center justify-center">
                    <span className="text-gray-500">No Image</span>
                </div>
                <div className="info p-3 py-5 px-8 w-[70%]">
                    <h6 className="text-[15px] text-gray-500">No Category</h6>
                    <h3 className="text-[18px] font-[500] mb-2 text-[#000]">No Product Data</h3>
    ...
    return (
        <div className="productItem shadow-lg rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center">
            <div className="group imgWrapper w-[30%] overflow-hidden rounded-md relative">
                ...
                {hasDiscount && (
                    <span className="discount flex items-center absolute top-[10px] left-[10px] z-50 bg-[#ff5252] text-white rounded-lg px-2 py-1 text-[12px] font-[500]">
                        -{discountPercentage}%
                    </span>
                )}
            ...
            <div className="info p-3 py-5 px-8 w-[70%]">
                <h6 className="text-[15px] !font-[400] text-gray-600" title={getCategoryNames(product.categories)}>
                ...
                <div className="flex items-center gap-2 mt-2">
                    {product.discounted_price || product.original_price ? (
                        <div className="flex items-center gap-2 flex-wrap">
                            {hasDiscount ? (
                                <>
                                    <span className="price text-[#ff5252] font-[600] text-[16px]">
                                        {formatPrice(product.discounted_price)}
                                    </span>
                                    <span className="original-price text-gray-400 font-[400] text-[14px] line-through">
