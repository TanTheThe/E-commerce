        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex-1">
                    ...
                    {gr.purchase_order && (
                        <p className="text-xs text-blue-600 mt-1">
                            PO: {gr.purchase_order.po_number}
                        </p>
                    )}
                </div>
            ...
            <div className="space-y-2 mb-3 text-sm">
                <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{gr.supplier?.name || 'N/A'}</span>
                </div>
                <div className="flex justify-between">
                    <span className="text-gray-500">Kho:</span>
                    <span className="font-medium text-gray-900">{gr.warehouse?.name || 'N/A'}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{formatDate(gr.created_at)}</span>
                </div>
            </div>
...
export default GoodsReceiptCard;